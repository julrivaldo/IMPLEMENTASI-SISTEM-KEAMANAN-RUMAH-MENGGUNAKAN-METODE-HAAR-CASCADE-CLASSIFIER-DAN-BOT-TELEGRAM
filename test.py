...
# Digunakan untuk membuka dialog pemilihan file pada aplikasi berbasis GUI.
from tkinter import filedialog
# Untuk menampilkan pesan kotak dialog pada aplikasi berbasis GUI.
from tkinter import messagebox
import winsound  # Digunakan untuk memainkan suara saat sistem berjalan.
import cv2  # Untuk pemrosesan gambar atau video berjalan dalam sistem
import os  # Menampilkan daftar file di direktori
import time  # Untuk menyediakan fungsi menunggu waktu.
# Untuk mendukung array multidimensi dan berbagai fungsi matematika atau numerik.
import numpy as np
# mengetahui pustaka standar Python untuk membuat aplikasi GUI.
import tkinter as tk
import tkinter.font as font  # digunakan untuk mengatur font dalam GUI Tkinter.
import telepot  # digunakan untuk mengontrol bot Telegram dari sistem aplikasi.
# digunakan untuk menampilkan gambar di aplikasi Tkinter
...
def collect_data(name, ids):
    ...
    # membuat directory dataset folder
    ...
    def show_frame():
        ...
        if cv2.waitKey(1) == 27 or count > 350:
            ...
            cv2.destroyAllWindows()  # menutup open cv
            cap.release()  # menyalakan kamera
            winsound.Beep(900, 1000) #suara beep ketika sudah selesai
            intructions.config(
