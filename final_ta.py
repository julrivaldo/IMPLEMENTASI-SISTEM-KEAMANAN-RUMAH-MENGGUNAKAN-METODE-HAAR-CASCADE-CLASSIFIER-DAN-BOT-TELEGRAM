        ...
        if len(faces) > 0:
            ...
            for x, y, w, h in faces:
                ...
                if label[1] < 80:
                    ...
                    # Menampilkan pesan bahwa wajah terdeteksi
                    intructions.config(text='terdeteksi')
                    # Menyimpan gambar wajah yang terdeteksi sebagai "dikenal.jpg"
                    ...
                    if not image_sent:
                        ...
                        image_sent = True
                        # Menampilkan pesan bahwa wajah tidak dikenal
                        intructions.config(text='tidak dikenal')
